...
from deerflow.config.agent_middlewares_config import AgentMiddlewaresConfig
...
class AppConfig(BaseModel):
    ...
    agent_middlewares: AgentMiddlewaresConfig = Field(default_factory=AgentMiddlewaresConfig, description="Config-driven per-agent middleware extension points")
